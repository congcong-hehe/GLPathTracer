...
int main()
{
    ...
    path_shader.setVec3("materials[0].color", 1.0f, 1.0f, 1.0f);    // 白色
    ...
    path_shader.setVec3("materials[3].color", 0.5f, 1.0f, 1.0f);    // 绿色

    path_shader.setVec3("materials[4].color", 0.5f, 0.5f, 1.0f);    // 蓝色
